    ...
    >
      <label className="w-full" style={{ position: "relative" }}>
        ...
        <input
          ...
          className="w-full rounded-[0.5rem] bg-[] text-white"
        />
      </label>
      <label className="relative">
        ...
        <input
          ...
          className="w-full rounded-[0.5rem] bg-[] p-[12px] pr-12 text-white"
        /> 
      ...
      <button type="submit" className="mt-6 rounded-[8px] bg-yellow-300 py-[8px] px-[12px] font-medium text-[]">
        Sign In
      </button>
    </form>
  );
